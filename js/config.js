...
export const REALTIME_SEGMENT_SEARCH_AHEAD = 3;
export const REALTIME_SEGMENT_SEARCH_BEHIND = 1;
export const REALTIME_SEGMENT_SNAP_MAX_METERS = 350;
export const REALTIME_STOPPED_HOLD_SECONDS = 25;
